...
type Status struct {
	...
	TotalCount       int             `json:"total_count,omitempty" bson:"total_count,omitempty"`
	SuccessCount     int             `json:"success_count,omitempty" bson:"success_count,omitempty"`
	Successes        []StatusDetails `json:"successes,omitempty" bson:"successes,omitempty"`
	FailureCount     int             `json:"failure_count,omitempty" bson:"failure_count,omitempty"`
	Failures         []StatusDetails `json:"failures,omitempty" bson:"failures,omitempty"`
	PendingCount     int             `json:"pending_count,omitempty" bson:"pending_count,omitempty"`
	Pendings         []StatusDetails `json:"pendings,omitempty" bson:"pendings,omitempty"`
}
