...
type TAXIIError struct {
	...
	ErrorID         string                 `json:"error_id,omitempty" bson:"error_id,omitempty"`
	ErrorCode       string                 `json:"error_code,omitempty" bson:"error_code,omitempty"`
	HTTPStatus      string                 `json:"http_status,omitempty" bson:"http_status,omitempty"`
	ExternalDetails string                 `json:"external_details,omitempty" bson:"external_details,omitempty"`
