...
*/
func Decode(data []byte) (*IPv4Addr, error) {
	var o IPv4Addr
...
*/
func (o *IPv4Addr) UnmarshalJSON(b []byte) error {
...
*/
func (o *IPv4Addr) Encode() ([]byte, error) {
...
JSON
*/
func (o *IPv4Addr) EncodeToString() (string, error) {
	data, err := o.Encode()
	if err != nil {
		return "", err
	}
